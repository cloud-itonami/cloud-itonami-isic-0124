# Operator Quickstart — Pome- and Stone-Fruit Orchard Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0124** (`cloud-itonami-isic-0124`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0124.git
cd cloud-itonami-isic-0124
```
...
- Blueprint governor key: `pome-stone-operations-governor`
- Likely source path: `pomestoneops.governor.cljc`
